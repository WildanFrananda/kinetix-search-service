...
func FromEnvironment() (Config, error) {
	...
	cfg := Config{
		...
		CatalogServerName:  optional("SEARCH_CATALOG_SERVER_NAME", "kinetix-catalog-service"),
		IdentityServerName: optional("SEARCH_IDENTITY_SERVER_NAME", "kinetix-identity-service"),
		OrderServerName:    optional("SEARCH_ORDER_SERVER_NAME", "kinetix-order-service"),
